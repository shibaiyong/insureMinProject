<template>
  <div class="productinfo">
    ...
    <div class="product productrecord">
        <h3>产品介绍</h3>
        <ul>
            <li><span>交易规则</span><span>随时可买</span></li>
            <li><span>收益方式</span><span>T日15:00前买入，T+1日计算收益，T+2显示首日收益；T日15:00后买入，T+2日计算收益，T+3日显示首日收益（T为工作日）</span></li>
            <li><span>快速取出</span><span>随时可取实时到账</span></li>
            <li><span>普通取出</span><span>随时可取实时到账随时可取实时到账</span></li>
        </ul>
    ...
    <div class="product productdes">
        <h3>产品档案</h3>
        <ul>
            <li><span>基金名称</span><span>民生加银现金宝货币市场基金</span></li>
            <li><span>基金代码</span><span>000371</span></li>
            <li><span>基金管理人员</span><span>民生加银基金管理有限公司</span></li>
    ...
    <div class="permenulist">
        <ul>
            <li><span>常见问题</span><div>更多<img src="@/assets/img/rightarow@2x.png"/></div></li>
        </ul>
    </div>
...
export default {
      ...
      this.serisedata = [
        {
          name: "销量",
          type: "line",
          data: [5.0, 2.0, 3.6, 7.1, 8.1, 9]
        }
      ];
    },

    setXaxisData() {
      this.xaxisdata = ["06/11", "06/12", "05/14", "09/17", "10/19", "13/17"];
    },
    setOption() {
      return {
        title: {
  ...
  computed: {},
  mounted() {
    this.initeEcharts("income");
    this.initeEcharts("incomerate");
  },
  components: {
    MyHeader,
    Service,
